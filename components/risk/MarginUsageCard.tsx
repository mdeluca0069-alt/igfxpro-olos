...
export interface MarginUsageCardProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function MarginUsageCard({
  title = "MarginUsageCard",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: MarginUsageCardProps) {
  const toneClass = {
...
export default MarginUsageCard;
