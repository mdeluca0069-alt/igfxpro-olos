...
export interface LeverageRiskPanelProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function LeverageRiskPanel({
  title = "LeverageRiskPanel",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: LeverageRiskPanelProps) {
  const toneClass = {
...
export default LeverageRiskPanel;
