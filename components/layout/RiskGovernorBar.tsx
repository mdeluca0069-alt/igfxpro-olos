...
export interface RiskGovernorBarProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function RiskGovernorBar({
  title = "RiskGovernorBar",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: RiskGovernorBarProps) {
  const toneClass = {
...
export default RiskGovernorBar;
