...
export interface OrderBlocksOverlayProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function OrderBlocksOverlay({
  title = "OrderBlocksOverlay",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: OrderBlocksOverlayProps) {
  const toneClass = {
...
export default OrderBlocksOverlay;
