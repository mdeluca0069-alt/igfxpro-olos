...
export interface DeltaFlowOverlayProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function DeltaFlowOverlay({
  title = "DeltaFlowOverlay",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: DeltaFlowOverlayProps) {
  const toneClass = {
...
export default DeltaFlowOverlay;
