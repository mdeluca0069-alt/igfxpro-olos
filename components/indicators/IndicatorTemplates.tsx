...
export interface IndicatorTemplatesProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
...
export function IndicatorTemplates({
  title = "IndicatorTemplates",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: IndicatorTemplatesProps) {
  const toneClass = {
...
export default IndicatorTemplates;
