...
export interface AIIndicatorRecommendationsProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AIIndicatorRecommendations({
  title = "AIIndicatorRecommendations",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AIIndicatorRecommendationsProps) {
  const toneClass = {
...
export default AIIndicatorRecommendations;
