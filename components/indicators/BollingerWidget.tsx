...
export interface BollingerWidgetProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function BollingerWidget({
  title = "BollingerWidget",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: BollingerWidgetProps) {
  const toneClass = {
...
export default BollingerWidget;
