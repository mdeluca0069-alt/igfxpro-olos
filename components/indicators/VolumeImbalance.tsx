...
export interface VolumeImbalanceProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function VolumeImbalance({
  title = "VolumeImbalance",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: VolumeImbalanceProps) {
  const toneClass = {
...
export default VolumeImbalance;
