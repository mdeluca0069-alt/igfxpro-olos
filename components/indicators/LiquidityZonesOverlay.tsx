...
export interface LiquidityZonesOverlayProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function LiquidityZonesOverlay({
  title = "LiquidityZonesOverlay",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: LiquidityZonesOverlayProps) {
  const toneClass = {
...
export default LiquidityZonesOverlay;
