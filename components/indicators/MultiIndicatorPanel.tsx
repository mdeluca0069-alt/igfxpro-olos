...
export interface MultiIndicatorPanelProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function MultiIndicatorPanel({
  title = "MultiIndicatorPanel",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: MultiIndicatorPanelProps) {
  const toneClass = {
