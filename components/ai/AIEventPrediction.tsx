...
export interface AIEventPredictionProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AIEventPrediction({
  title = "AIEventPrediction",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AIEventPredictionProps) {
  const toneClass = {
...
export default AIEventPrediction;
