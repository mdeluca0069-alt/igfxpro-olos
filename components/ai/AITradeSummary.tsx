...
export interface AITradeSummaryProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AITradeSummary({
  title = "AITradeSummary",
  value,
  tone = "default",
  className = "",
  children,
