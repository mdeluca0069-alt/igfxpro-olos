...
export interface AIVolatilityRadarProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AIVolatilityRadar({
  title = "AIVolatilityRadar",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AIVolatilityRadarProps) {
  const toneClass = {
...
export default AIVolatilityRadar;
