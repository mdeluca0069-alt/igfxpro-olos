...
export interface AIConfidenceGaugeProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
...
export function AIConfidenceGauge({
  title = "AIConfidenceGauge",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AIConfidenceGaugeProps) {
  const toneClass = {
...
export default AIConfidenceGauge;
