...
export interface WalletSecurityStatusProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
...
export function WalletSecurityStatus({
  title = "WalletSecurityStatus",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: WalletSecurityStatusProps) {
  const toneClass = {
...
export default WalletSecurityStatus;
