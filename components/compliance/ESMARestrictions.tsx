...
export interface ESMARestrictionsProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function ESMARestrictions({
  title = "ESMARestrictions",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: ESMARestrictionsProps) {
  const toneClass = {
...
export default ESMARestrictions;
