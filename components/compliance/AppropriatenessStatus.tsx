...
export interface AppropriatenessStatusProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AppropriatenessStatus({
  title = "AppropriatenessStatus",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AppropriatenessStatusProps) {
  const toneClass = {
...
export default AppropriatenessStatus;
