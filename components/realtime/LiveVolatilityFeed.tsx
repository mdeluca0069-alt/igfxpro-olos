...
export interface LiveVolatilityFeedProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function LiveVolatilityFeed({
  title = "LiveVolatilityFeed",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: LiveVolatilityFeedProps) {
  const toneClass = {
...
export default LiveVolatilityFeed;
