...
export interface VolatilityExplosionAlertProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function VolatilityExplosionAlert({
  title = "VolatilityExplosionAlert",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: VolatilityExplosionAlertProps) {
  const toneClass = {
...
export default VolatilityExplosionAlert;
