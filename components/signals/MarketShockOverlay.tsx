...
export interface MarketShockOverlayProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function MarketShockOverlay({
  title = "MarketShockOverlay",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: MarketShockOverlayProps) {
  const toneClass = {
...
export default MarketShockOverlay;
