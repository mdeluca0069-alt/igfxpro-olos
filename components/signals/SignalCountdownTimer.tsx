...
export interface SignalCountdownTimerProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SignalCountdownTimer({
  title = "SignalCountdownTimer",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: SignalCountdownTimerProps) {
  const toneClass = {
...
export default SignalCountdownTimer;
