...
export interface EventLockOverlayProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function EventLockOverlay({
  title = "EventLockOverlay",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: EventLockOverlayProps) {
  const toneClass = {
...
export default EventLockOverlay;
