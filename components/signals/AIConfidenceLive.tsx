...
export interface AIConfidenceLiveProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AIConfidenceLive({
  title = "AIConfidenceLive",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AIConfidenceLiveProps) {
  const toneClass = {
...
export default AIConfidenceLive;
