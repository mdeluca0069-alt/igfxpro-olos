...
export interface SignalPriorityBadgeProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SignalPriorityBadge({
  title = "SignalPriorityBadge",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: SignalPriorityBadgeProps) {
  const toneClass = {
...
export default SignalPriorityBadge;
