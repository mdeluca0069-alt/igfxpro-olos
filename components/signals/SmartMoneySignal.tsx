...
export interface SmartMoneySignalProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SmartMoneySignal({
  title = "SmartMoneySignal",
  value,
  tone = "default",
  className = "",
  children,
...
export default SmartMoneySignal;
