...
export interface SignalScenarioPanelProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SignalScenarioPanel({
  title = "SignalScenarioPanel",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: SignalScenarioPanelProps) {
  const toneClass = {
...
export default SignalScenarioPanel;
