...
export interface PartialFillMonitorProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function PartialFillMonitor({
  title = "PartialFillMonitor",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: PartialFillMonitorProps) {
  const toneClass = {
...
export default PartialFillMonitor;
