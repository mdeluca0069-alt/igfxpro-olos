...
export interface ExecutionLatencyWidgetProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function ExecutionLatencyWidget({
  title = "ExecutionLatencyWidget",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: ExecutionLatencyWidgetProps) {
  const toneClass = {
