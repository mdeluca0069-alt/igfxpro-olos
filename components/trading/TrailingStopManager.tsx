...
export interface TrailingStopManagerProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function TrailingStopManager({
  title = "TrailingStopManager",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: TrailingStopManagerProps) {
  const toneClass = {
