...
export interface EventRiskShieldPanelProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function EventRiskShieldPanel({
  title = "EventRiskShieldPanel",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: EventRiskShieldPanelProps) {
  const toneClass = {
...
export default EventRiskShieldPanel;
