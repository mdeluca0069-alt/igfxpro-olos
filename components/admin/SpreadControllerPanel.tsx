...
export interface SpreadControllerPanelProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SpreadControllerPanel({
  title = "SpreadControllerPanel",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: SpreadControllerPanelProps) {
  const toneClass = {
...
export default SpreadControllerPanel;
