...
export interface MarginRiskGridProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function MarginRiskGrid({
  title = "MarginRiskGrid",
  value,
  tone = "default",
  className = "",
  children,
