...
export interface TradingViewBridgeProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function TradingViewBridge({
  title = "TradingViewBridge",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: TradingViewBridgeProps) {
  const toneClass = {
...
export default TradingViewBridge;
