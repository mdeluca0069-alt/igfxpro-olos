...
export interface RiskAutomationProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function RiskAutomation({
  title = "RiskAutomation",
  value,
  tone = "default",
  className = "",
  children,
