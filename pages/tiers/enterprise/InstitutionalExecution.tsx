...
export interface InstitutionalExecutionProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function InstitutionalExecution({
  title = "InstitutionalExecution",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: InstitutionalExecutionProps) {
  const toneClass = {
...
export default InstitutionalExecution;
