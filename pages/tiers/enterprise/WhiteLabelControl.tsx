...
export interface WhiteLabelControlProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function WhiteLabelControl({
  title = "WhiteLabelControl",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: WhiteLabelControlProps) {
  const toneClass = {
...
export default WhiteLabelControl;
