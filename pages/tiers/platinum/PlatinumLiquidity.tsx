...
export interface PlatinumLiquidityProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function PlatinumLiquidity({
  title = "PlatinumLiquidity",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: PlatinumLiquidityProps) {
  const toneClass = {
...
export default PlatinumLiquidity;
