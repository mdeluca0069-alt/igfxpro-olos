...
export interface PlatinumWorkspaceProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function PlatinumWorkspace({
  title = "PlatinumWorkspace",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: PlatinumWorkspaceProps) {
  const toneClass = {
...
export default PlatinumWorkspace;
