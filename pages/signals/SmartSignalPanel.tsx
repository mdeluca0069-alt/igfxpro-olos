...
export interface SmartSignalPanelProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SmartSignalPanel({
  title = "SmartSignalPanel",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: SmartSignalPanelProps) {
  const toneClass = {
...
export default SmartSignalPanel;
