...
export interface SignalScenarioEngineProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SignalScenarioEngine({
  title = "SignalScenarioEngine",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: SignalScenarioEngineProps) {
  const toneClass = {
...
export default SignalScenarioEngine;
