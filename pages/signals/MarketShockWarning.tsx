...
export interface MarketShockWarningProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function MarketShockWarning({
  title = "MarketShockWarning",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: MarketShockWarningProps) {
  const toneClass = {
...
export default MarketShockWarning;
