...
export interface AIConfidenceSignalsProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AIConfidenceSignals({
  title = "AIConfidenceSignals",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AIConfidenceSignalsProps) {
  const toneClass = {
...
export default AIConfidenceSignals;
