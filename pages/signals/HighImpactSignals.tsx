...
export interface HighImpactSignalsProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function HighImpactSignals({
  title = "HighImpactSignals",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: HighImpactSignalsProps) {
  const toneClass = {
...
export default HighImpactSignals;
