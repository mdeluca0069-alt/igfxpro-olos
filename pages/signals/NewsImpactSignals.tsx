...
export interface NewsImpactSignalsProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function NewsImpactSignals({
  title = "NewsImpactSignals",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: NewsImpactSignalsProps) {
  const toneClass = {
...
export default NewsImpactSignals;
