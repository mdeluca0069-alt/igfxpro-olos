...
export interface SignalProbabilityProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function SignalProbability({
  title = "SignalProbability",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: SignalProbabilityProps) {
  const toneClass = {
...
export default SignalProbability;
