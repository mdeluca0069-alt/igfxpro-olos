...
export interface CorrelationScannerProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function CorrelationScanner({
  title = "CorrelationScanner",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: CorrelationScannerProps) {
  const toneClass = {
