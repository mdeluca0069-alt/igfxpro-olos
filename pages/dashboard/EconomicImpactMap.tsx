...
export interface EconomicImpactMapProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function EconomicImpactMap({
  title = "EconomicImpactMap",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: EconomicImpactMapProps) {
  const toneClass = {
...
export default EconomicImpactMap;
