...
export interface AIIndicatorOverlayProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function AIIndicatorOverlay({
  title = "AIIndicatorOverlay",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: AIIndicatorOverlayProps) {
  const toneClass = {
...
export default AIIndicatorOverlay;
