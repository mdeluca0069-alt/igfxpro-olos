...
export interface MarketImpactEngineProps extends HTMLAttributes<HTMLElement> {
  title?: string;
  value?: ReactNode;
  tone?: "default" | "success" | "warning" | "danger";
}

export function MarketImpactEngine({
  title = "MarketImpactEngine",
  value,
  tone = "default",
  className = "",
  children,
  ...props
}: MarketImpactEngineProps) {
  const toneClass = {
...
export default MarketImpactEngine;
